...
$(document).ready(function() {
	...
	sr.reveal('.anileft', { delay: 300 , origin: "left" });
	sr.reveal('.anitop', { delay: 300 , origin: "top" });
	sr.reveal('.anibottom', { delay: 300 , origin: "bottom" });
	sr.reveal('.aniright', { delay: 300 , origin: "right" });